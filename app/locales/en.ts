export default {
  ...
  performanceDescription: 'For the best experience with minimal lag, use a 5GHz Wi-Fi connection on both devices. If you notice latency, try lowering the resolution in the app settings.'
};
