export default {
  ...
  performanceDescription: 'Pour la meilleure expérience avec un minimum de latence, utilisez une connexion Wi-Fi 5GHz sur les deux appareils. Si vous remarquez de la latence, essayez de réduire la résolution dans les paramètres de l\'application.'
};
