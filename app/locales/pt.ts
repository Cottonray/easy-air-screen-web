export default {
  ...
  performanceDescription: 'Para a melhor experiência com atraso mínimo, use uma conexão Wi-Fi de 5GHz em ambos os dispositivos. Se notar latência, tente diminuir a resolução nas configurações do aplicativo.'
};
