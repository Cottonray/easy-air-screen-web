export default {
  ...
  performanceDescription: 'Für die beste Erfahrung mit minimaler Verzögerung verwenden Sie eine 5-GHz-Wi-Fi-Verbindung auf beiden Geräten. Wenn Sie Latenz bemerken, versuchen Sie, die Auflösung in den App-Einstellungen zu verringern.'
};
