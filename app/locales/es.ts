export default {
  ...
  performanceDescription: 'Para la mejor experiencia con un retraso mínimo, usa una conexión Wi-Fi de 5GHz en ambos dispositivos. Si notas latencia, intenta reducir la resolución en la configuración de la aplicación.'
};
